...
class FraudDetectionAgent(Agent):
    def __init__(self, kernel):
        ...
        object.__setattr__(self, "agent", self.project_client.agents.get_agent("asst_aAN7JLcRj88IiadigD4qGh9n"))
        object.__setattr__(self, "thread", self.project_client.agents.get_thread("thread_XQraGnGknQbEP0tciyqjVdyV"))
    ...
    def invoke_stream(self, input_data):
        yield f"FraudDetectionAgent streaming response to {input_data}"