...
class AssessmentAgent(Agent):
    def __init__(self, kernel):
        ...
        object.__setattr__(self, "agent", self.project_client.agents.get_agent("asst_cxoUFvmoHSyOPFVtS6vFTcRg"))
        object.__setattr__(self, "thread", self.project_client.agents.get_thread("thread_w10xk9N8PhtA1x6hzgDoCXTz"))
    ...
    def invoke_stream(self, input_data):
        yield f"AssessmentAgent streaming response to {input_data}"