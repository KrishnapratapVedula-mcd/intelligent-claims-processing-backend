...
class IntakeAgent(Agent):
    def __init__(self, kernel):
        ...
        object.__setattr__(self, "agent", self.project_client.agents.get_agent("asst_4EsbNyWb8oiFuctcQMOOBuw8"))
        object.__setattr__(self, "thread", self.project_client.agents.get_thread("thread_EAIqK6dlNCPdq3ZDhiditTJV"))
    ...
    def invoke_stream(self, input_data):
        yield f"IntakeAgent streaming response to {input_data}"